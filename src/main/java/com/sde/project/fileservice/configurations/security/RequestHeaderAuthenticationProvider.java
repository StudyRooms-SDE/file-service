package com.sde.project.fileservice.configurations.security;
...
public class RequestHeaderAuthenticationProvider implements AuthenticationProvider {
    ...
    @Value("${x.auth.secret}")
    private String xAuthSecret;

    @Override
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        String authSecretKey = String.valueOf(authentication.getPrincipal());

        if(StringUtils.isBlank(authSecretKey) || !authSecretKey.equals(xAuthSecret)) {
